...
```
Download poc1: [nasm_2-14rc0_heap-buffer-overflow_preproc1227.zip](https://github.com/fengzhengzhan/FzzVul/blob/main/nasm/nasm_2-14rc0_heap-buffer-overflow_preproc1227.zip)
